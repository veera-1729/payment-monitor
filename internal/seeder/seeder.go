...
func (s *Seeder) seedGatewayMethodAlertPayments(w http.ResponseWriter, r *http.Request) {
	...
	payments := []struct {
		...
		{
			ID:         "pay_HDFC_UPI_OLD1",
			CreatedAt:  now - 3600,
			PaymentID:  "pay_HDFC_UPI_OLD1",
			MerchantID: "merchant1",
			Amount:     5000,
			Currency:   "INR",
			Method:     "upi",
		...
		{
			ID:         "pay_HDFC_UPI_OLD2",
			CreatedAt:  now - 3600,
			PaymentID:  "pay_HDFC_UPI_OLD2",
			MerchantID: "merchant1",
			Amount:     7000,
			Currency:   "INR",
			Method:     "upi",
		...
		{
			ID:         "pay_HDFC_UPI_OLD3",
			CreatedAt:  now - 3600,
			PaymentID:  "pay_HDFC_UPI_OLD3",
			MerchantID: "merchant1",
			Amount:     9000,
			Currency:   "INR",
			Method:     "upi",
		...
		{
			ID:         "pay_HDFC_UPI_OLD4",
			CreatedAt:  now - 3600,
			PaymentID:  "pay_HDFC_UPI_OLD4",
			MerchantID: "merchant1",
			Amount:     6000,
			Currency:   "INR",
			Method:     "upi",
		...
		{
			ID:         "pay_HDFC_UPI_OLD5",
			CreatedAt:  now - 3600,
			PaymentID:  "pay_HDFC_UPI_OLD5",
			MerchantID: "merchant1",
			Amount:     8000,
			Currency:   "INR",
			Method:     "upi",
